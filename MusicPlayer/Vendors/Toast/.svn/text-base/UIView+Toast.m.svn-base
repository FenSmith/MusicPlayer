...
// activity
static const CGFloat CSToastActivityWidth       = 70.0;
static const CGFloat CSToastActivityHeight      = 70.0;
...
- (void)makeToastActivity:(id)position {
    ...
    UIView *bottomView = [[UIView alloc] initWithFrame:self.frame];
...
- (void)hideToastActivity {
    ...
    UIView *bottomView = (UIView*)[self viewWithTag:10001];
    if( bottomView != nil ){
...
- (void)hideView:(UIView *) view{
    ...
    UIView *bottomView = (UIView*)[view viewWithTag:10001];
    if( bottomView != nil ){
        [bottomView removeFromSuperview];
        bottomView = nil;
    }
    
    UIView *existingActivityView = (UIView *)objc_getAssociatedObject(view, &CSToastActivityViewKey);
    if (existingActivityView != nil) {
        [UIView animateWithDuration:CSToastFadeDuration
                              delay:0.0
                            options:(UIViewAnimationOptionCurveEaseIn | UIViewAnimationOptionBeginFromCurrentState)
                         animations:^{
                             ...
                             [existingActivityView removeFromSuperview];
                             objc_setAssociatedObject (view, &CSToastActivityViewKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
                         }];
    }
}
